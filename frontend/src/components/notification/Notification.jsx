  ...
  return (
    ...
    <div className="p-5" style={{background: "#6548bc"}}>
      <div class="card" style={{background: "#27bee3"}}>
        ...
        <div class="card-body">
          <h5 class="card-title mb-3">This {`0x`} address sended our certificate to you</h5>
          <p class="card-text">
    ...
    <div className="p-5" style={{background: "#6548bc"}}>
      <div class="card" style={{background: "#27bee3"}}>
        ...
        <div class="card-body">
          <h5 class="card-title mb-3">This {`0x`} provider issued the certificate to you. <br /> Now, you can check from your address{}</h5>
          <p class="card-text">
